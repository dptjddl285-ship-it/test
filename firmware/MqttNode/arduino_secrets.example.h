...
#define MQTT_HOST   "192.168.0.30"        // LAN IP of the machine running Mosquitto
#define MQTT_PORT   1883

// Your board's name on the broker: topics become physicalpknu/<name>/...
// Leave it empty ("") to fall back to "c6-" plus the last 3 bytes of the MAC.
// Pick something unique - two boards sharing a name will fight over the same
// topics and keep kicking each other off the broker.
