// XIAO ESP32C6 MQTT node for the physicalpknu broker.
//
//   subscribes  physicalpknu/<id>/led/set      payload "on" | "off" | "toggle"
//   publishes   physicalpknu/<id>/led/state    "on" | "off"            (retained)
//   publishes   physicalpknu/<id>/sensor/a0    {"raw":2048,"mv":1650}  every 2s
//   publishes   physicalpknu/<id>/status       "online" | "offline"    (retained, LWT)
//
...
void connectWiFi() {
  ...
  // DTIM beacon, which on a busy physicalpknu AP shows up as laggy LED commands
...
void setup() {
  ...
  String base   = "physicalpknu/" + deviceId;
